...
| PATCH  api/v1/intervention/<int:intervention_Id>/addimage | Add image on an intervention  |
| PATCH  api/v1/red-flags/<int:redflag_Id>/addimage         | Add image on a redflag        |
